...
#    Updated: 2025/01/07 16:08:51 by nakoriko         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = main.c signals.c\
	...
	parser/parsing_check.c parser/preparsing_split.c parser/parsing_main.c parser/parsing_types.c parser/parsing_utils.c parser/path_identifier.c\
	...
	pipes/pipes_main.c parser/quotes_and_expansion.c parser/token_list_creation.c utils/free_lists.c
OBJ = $(SRC:%.c=$(OBJDIR)/%.o)
